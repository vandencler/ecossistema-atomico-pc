...
## ? RESOLVED ITEMS
- [x] **DB Permissions (EAV-94):** Verified ðŸŸ¢. \eav_writer\ has full access to \wshop\ schema (docitem, produto, documen, etc.).
- [x] **Docitem Indexes (EAV-94):** Verified ðŸŸ¢. \idx_docitem_idpessoa\ and \idx_docitem_idproduto\ are ACTIVE.
- [x] **Trigram Search (EAV-89):** Verified ðŸŸ¢. 6 core trigram indexes on \wshop.pessoas\ are ACTIVE.
